          ...
          <div className="mx-auto max-w-2xl sm:py-48 2xl:py-56 lg:py-20 text-gray-100">
            <div className="">
              ...
              <p className="mt-6 text-gray-300 text-md leading-8">
                Computers always faccinated me, back in 2021 I was courius on
                how websites and systems were able to do what they do and that
                made me do some research on it, usually googling everything that
                came to my mind, this led me to coding.
              </p>
