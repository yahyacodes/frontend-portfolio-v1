      ...
      <Fade top distance="50%">
          ...
          <div className="p-5">
            ...
            <div className="mt-5">
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                ...
                and I followed the documentation in of this API to build out
                this application.
              </p>
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                ...
                acknowledge about them by my nephews and if you want to know
                about them you can have a look at them in my app.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-md bg-color ring-1 ring-gray-100/10 rounded-lg shadow">
          ...
          <div className="p-5">
            ...
            <div className="mt-5">
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                In this Post feeds App, I used react and tailwindcss to build
                this application. This application is fetching data from{" "}
                <a
                  className="hover:text-blue-400"
                  target="_blank"
              ...
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                In this application a user can create a post and the user is
                able to see the post. A user can also delete post after the user
                created the post
              </p>
          ...
          <div className="p-5">
            ...
            <div className="mt-5">
              ...
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                ...
                the same for savings and expenses. This appliaction will help
                the user to know of how they spent their money.
              </p>
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                This is a very basic application a user does not need to login
                or create and account to get access of this application.
              </p>
            </div>
          </div>
        </div>
